...
namespace HelloMaikelTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class HelloMaikelContractTests : IClassFixture<CheckpointFixture<HelloMaikelContractTests>>
    {
        ...
        public HelloMaikelContractTests(CheckpointFixture<HelloMaikelContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<HelloMaikelContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<HelloMaikelContract>(c => c.changeNumber(42));
